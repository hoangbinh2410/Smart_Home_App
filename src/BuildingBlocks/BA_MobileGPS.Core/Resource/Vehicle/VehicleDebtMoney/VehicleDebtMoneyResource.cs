...
namespace BA_MobileGPS.Core.Resource
{
    ...
    public partial class MobileResource
    {
        ...
        public static string VehicleDebtMoneyMessage_SuccessRegister => Get(MobileResourceNames.VehicleDebtMoneyMessage_SuccessRegister, " <font color=#0984e3> ✔  Phương tiện quá hạn sử dung: Chỉ được xem giám sát phương tiện.  <br> <font color=#ff7675> ✔  Phương tiện khóa chưa đóng phí: Không được xem chức năng nào trên hệ thống.. <br> <font color=#6c5ce7> ✔  Phương tiện dừng dịch vụ: Phương tiện không được xem tính năng nào trên hệ thống và không truyền dữ liệu trên TCĐB ", "✔  Vehicle overdue: Only watch the vehicle.(Blue) \n ✔  Un-paid lock: No function can be viewed on the system..(Red) \n ✔  Guaranteed vehicles: Only see reports and schedules until the end of the guarantee day (Violet)");
