...
namespace BA_MobileGPS.Core.Resource
{
    ...
    public partial class MobileResource
    {
        ...
        public static string DetailVehicle_Label_Time => Get(MobileResourceNames.DetailVehicle_Label_Time, "Thời gian", "Update time");
        public static string DetailVehicle_Label_Speed => Get(MobileResourceNames.DetailVehicle_Label_Speed, "Vận tốc", "GPS speed");
