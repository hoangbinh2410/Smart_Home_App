...
namespace BA_MobileGPS.Core.Resource
{
    public partial class MobileResource
    {
        ...
        public static string Login_Popup_Landing => Get(MobileResourceNames.Login_Popup_Landing, "Tài khoản hoặc mật khẩu không chính xác", "Account or password is incorrect");
