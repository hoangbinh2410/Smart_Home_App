...
namespace BA_MobileGPS.Core.Resources
{
    public partial class MobileResource
    {
        ...
        public static string AccountTab_Label_DeviceManual => Get(MobileResourceNames.AccountTab_Label_DeviceManual, "Hướng dẫn sử dụng", "Helper");
        ...
        public static string AccountTab_Label_Upgrade => Get(MobileResourceNames.AccountTab_Label_Upgrade, "Nâng cấp phiên bản {0}", "Upgrade Version {0}");
