...
namespace BA_MobileGPS.Core.Resources
{
    public partial class MobileResource
    {
        ...
        public static string Camera_Message_StopStreamingOK => Get(MobileResourceNames.Camera_Message_StopStreamingOK, "Hệ thống đang kết nối đến thiết bị để phát video. Vui lòng đợi trong giây lát.", "Stop watching live successfully. Please wait a moment for the device to go live");
        ...
        public static string Camera_Message_StopPlaybackOK => Get(MobileResourceNames.Camera_Message_StopPlaybackOK, "Hệ thống đang kết nối đến thiết bị để phát video. Vui lòng đợi trong giây lát.", "Stop playback successfully. Please wait a moment for the device to go live");
