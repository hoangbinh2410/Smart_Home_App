...
namespace BA_MobileGPS.Core.Resources
{
    public partial class MobileResource
    {
        ...
        public static string Login_Message_LoginOneKey => Get(MobileResourceNames.Login_Message_LoginOneKey, "Tài khoản và mật khẩu phải có ít nhất 2 kí tự", "Username and password must be at least 2 characters");
