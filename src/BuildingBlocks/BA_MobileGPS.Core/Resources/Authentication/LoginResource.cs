...
namespace BA_MobileGPS.Core.Resources
{
    public partial class MobileResource
    {
        ...
        public static string Login_ForgotPassword_PopupContent => GetResourceNotDB(MobileResourceNames.Login_ForgotPassword_PopupContent, "Để đảm bảo an toàn thông tin, Quý khách vui lòng liên hệ <strong> <font color='{0}'> {1} </font> </strong> để được cấp lại mật khẩu", " To ensure information security, please contact <strong> <font color='{0}'> {1} </font> </strong> for a password reset");
