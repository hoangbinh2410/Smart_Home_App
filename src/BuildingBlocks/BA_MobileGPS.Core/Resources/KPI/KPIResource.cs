...
namespace BA_MobileGPS.Core.Resources
{
    public partial class MobileResource
    {
        ...
        public static string Chart_Title_ScoreDisplay => Get(MobileResourceNames.Chart_Title_ScoreDisplay, "Điểm tiêu chuẩn", "Standard score");
        public static string Chart_Title_ScoreActual => Get(MobileResourceNames.Chart_Title_ScoreActual, "Điểm thực tế", "Actual score");
