namespace BA_MobileGPS.Core.Constant
{
    public static class ParameterKey
    {
        ...
        public const string ReportStopParkingVehicleSelected = "ReportStopParkingVehicleSelected";
        public const string ReportDetailsSelected = "ReportDetailsSelected";
        public const string ReportActivitySummariesSelected = "ReportActivitySummariesSelected";
        public const string ReportFuelsSummariesSelected = "ReportFuelsSummariesSelected";
        public const string ReportFuelsSummariesTotalSelected = "ReportFuelsSummariesTotalSelected";
        public const string Company = "Company";
        public const string VehicleGroups = "VehicleGroups";
        public const string VehicleRoute = "VehicleRoute";
