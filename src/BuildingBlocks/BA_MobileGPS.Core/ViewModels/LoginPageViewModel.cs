...
namespace BA_MobileGPS.Core.ViewModels
{
        public class LoginPageViewModel : ViewModelBase
        {
            ...
            public LanguageRespone Language { get => language; set => SetProperty(ref language, value); }
            ...
            public bool isUseForgotpassword;
            public bool IsUseForgotpassword { get => isUseForgotpassword; set => SetProperty(ref isUseForgotpassword, value); }
            ...
            private Task GetMobileSetting()
            {
                ...
                (result) =>
                {
                    if (result != null && result.Count > 0)
                    {
                        ...
                        IsUseForgotpassword = MobileSettingHelper.IsUseForgotpassword;
            ...
            {
                SafeExecute(async () => await NavigationService.NavigateAsync("MasterDetailNavigationPage/ForgotPasswordPage", useModalNavigation: true));
            });
