...
namespace BA_MobileGPS.Core.ViewModels
{
    ...
    /// </Modified>
    public class SelectTimePickerViewModel : ViewModelBase
    {
        private readonly INavigationService _navigationService;
        private readonly IEventAggregator _eventAggregator;

        public SelectTimePickerViewModel(INavigationService navigationService, IEventAggregator eventAggregator) : base(navigationService)
        {
