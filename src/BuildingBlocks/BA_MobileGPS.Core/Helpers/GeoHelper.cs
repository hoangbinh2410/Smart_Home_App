...
namespace BA_MobileGPS.Core
{
    ...
    public static class GeoHelper
    {
        ...
        public static string LatitudeToDergeeMinSec(double lat, out PositionDergee positionDergee)
        {
            var ns = "N";
            if (lat < 0)
            {
            ...
            positionDergee = new PositionDergee() { Dergee = d, Min = m, Sec = s };
        ...
        public static string LongitudeToDergeeMinSec(double lng, out PositionDergee positionDergee)
        {
            var ew = "E";
            if (lng < 0)
            {
