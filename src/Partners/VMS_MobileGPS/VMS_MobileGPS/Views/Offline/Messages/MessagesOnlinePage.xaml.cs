...
namespace VMS_MobileGPS.Views
{
    ...
    public partial class MessagesOnlinePage : ContentPage
    {
        public MessagesOnlinePage()
        {
            InitializeComponent();
        }
        ...
        private async void Delete_Tapped(object sender, EventArgs e)
        {
            ...
            {
                if (((VisualElement)sender).BindingContext is MessageByUser item && BindingContext is MessagesOnlineViewModel viewModel)
                {
